...
class DykstraProjCompositeProj():
    ...
    :math:`C_i`, this class computes the convex projection :math:`P_C` to

    .. math::

        C = \cap_{i=1}^m C_i,

    the intersection of :math:`C_i` using Dykstra's algorithm,
    if :math:`C \neq \emptyset`.

    For :math:`m=2`, the projection :math:`P_C(x)` is computed by [1]_, [2]_, [3]_:
    ...
    * for :math:`k = 1, \ldots`
    ...
    For :math:`m \ge 2`, the projection :math:`P_C(x)` is computed by [4]_, [5]_, [6]_:
    ...
    * for :math:`k = 1, \ldots`
    ...
    def __init__(
        ...
        Args:
            projections (List[Callable[[NDArray], NDArray]]):
                A list of projection functions, each mapping :math:`x` to its
                projection :math:`P_i(x)` onto a convex set :math:`C_i`.
            max_iter (int, optional):
                The maximum number of iterations for Dykstra's algorithm.
                Default is 10.
        """
    ...
    def __call__(self, x: NDArray) -> NDArray:
        """compute projection :math:`P_C(x)` of :math:`x` onto :math:`C`.
    ...
    def set_projections(
        ...
        """Sets the list of projection functions

            projections (List[Callable[[NDArray], NDArray]]):
                A list of projection functions
        """
        self.projections = projections
